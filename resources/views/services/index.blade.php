...
<section class="bg-white shadow">
    <div class="container mx-auto px-6 py-6">
        <form action="{{ route('customer.services.index') }}" method="GET" class="flex flex-wrap gap-4">
            <div class="flex-1">
...
<section class="py-16 bg-pink-500 text-white">
    <div class="container mx-auto px-6 text-center">
        ...
        <a href="{{ route('customer.contact') }}" class="inline-block bg-white text-pink-500 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition">
            Liên hệ ngay
        </a>
    </div>
</section>
