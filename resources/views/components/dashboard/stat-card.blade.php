@props(['title', 'value', 'icon', 'color', 'link' => null, 'linkText' => 'Xem chi tiết'])
...
<div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
    ...
    <div class="p-6">
        <div class="text-center text-3xl font-bold {{ $textColor }}">{{ $value }}</div>
        <div class="text-center text-sm text-gray-500 mt-1">{{ $slot }}</div>
        @if($link)
        <div class="mt-4">
