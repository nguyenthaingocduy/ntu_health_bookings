...
<div class="container mx-auto px-6 py-8">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Tạo quyền mới</h1>
            <p class="text-sm text-gray-500 mt-1">Thêm quyền mới vào hệ thống</p>
        </div>
    ...
    <nav class="mb-8">
        <ol class="flex text-sm text-gray-500">
            ...
            <li class="text-pink-500 font-medium">Tạo quyền mới</li>
        </ol>
    </nav>
                ...
                <div class="p-6">
                    <form action="{{ route('admin.permissions.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" class="w-full px-4 py-2 border border-gray-300  rounded-lg focus:pink-2 focus:outline-none focus:ring-pink-500 hover:border-pink-500  @error('name') border-red-500 @enderror" id="name" name="name" value="{{ old('name') }}" required placeholder="Ví dụ: users.view">
                            @error('name')
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" class="w-full px-4 py-2 border border-gray-300  rounded-lg focus:pink-2 focus:outline-none focus:ring-pink-500 hover:border-pink-500 @error('display_name') border-red-500 @enderror" id="display_name" name="display_name" value="{{ old('display_name') }}" required placeholder="Ví dụ: Xem người dùng">
                            @error('display_name')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                <select class="w-full px-4 py-2 border border-gray-300  rounded-lg focus:pink-2 focus:outline-none focus:ring-pink-500 hover:border-pink-500 focus:ring-opacity-50 @error('group') border-red-500 @enderror" id="group" name="group" required>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea class="w-full px-4 py-2 border border-gray-300  rounded-lg focus:pink-2 focus:outline-none focus:ring-pink-500 hover:border-pink-500 focus:ring-opacity-50 @error('description') border-red-500 @enderror" id="description" name="description" rows="4" placeholder="Mô tả chi tiết về quyền này">{{ old('description') }}</textarea>
                            @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200 sticky top-6">
                ...
                <div class="p-6">
                    <div class="text-sm text-gray-600">
                        <p class="mb-4">Quyền xác định các hành động mà người dùng có thể thực hiện trong hệ thống.</p>
                        
                        <h4 class="font-medium text-gray-700 mb-2">Tên quyền</h4>
                        <p class="mb-4">Tên quyền nên theo định dạng: resource.action (ví dụ: users.view, users.create). Tên này được sử dụng trong mã để kiểm tra quyền.</p>
                        
                        <h4 class="font-medium text-gray-700 mb-2">Tên hiển thị</h4>
                        <p class="mb-4">Tên hiển thị là tên thân thiện với người dùng, được hiển thị trong giao diện.</p>
                        
                        <h4 class="font-medium text-gray-700 mb-2">Nhóm quyền</h4>
                        <p class="mb-4">Nhóm quyền giúp phân loại các quyền theo chức năng hoặc module. Ví dụ: Người dùng, Vai trò, Dịch vụ, v.v.</p>
                        
                        <div class="bg-yellow-50 border-l-4 border-yellow-500 text-yellow-700 p-4 mt-4">
                            <p class="font-medium">Lưu ý:</p>
                            <ul class="list-disc list-inside mt-2">
                                <li>Sau khi tạo quyền, bạn cần phân quyền cho vai trò hoặc người dùng.</li>
                                <li>Quyền mới sẽ tự động được gán cho vai trò Admin.</li>
                            </ul>
                        </div>
                    </div>
                </div>
