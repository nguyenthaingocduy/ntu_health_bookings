...
<div class="container mx-auto px-6 py-8">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Phân quyền người dùng</h1>
            <p class="text-sm text-gray-500 mt-1">Quản lý quyền của từng người dùng</p>
        </div>
        <div class="flex space-x-2">
            <a href="{{ route('admin.permissions.index') }}" class="flex items-center px-4 py-2 bg-pink-500 text-white rounded-lg hover:bg-pink-600 transition-colors duration-150 shadow-md">
    ...
    <nav class="mb-8">
        <ol class="flex text-sm text-gray-500">
            ...
            <li class="text-pink-500 font-medium">Phân quyền người dùng</li>
        </ol>
    </nav>
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
        ...
        <div class="p-6">
            <div class="mb-4">
                <input type="text" id="searchInput" placeholder="Tìm kiếm người dùng..." class="w-full md:w-1/3 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent">
            </div>
                        ...
                        <tr class="hover:bg-gray-50 user-row">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-gray-900 user-name">{{ $user->full_name }}</div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="{{ route('admin.permissions.edit-user-permissions', $user->id) }}" 
                                   class="text-indigo-600 hover:text-indigo-900 bg-indigo-100 hover:bg-indigo-200 px-3 py-2 rounded-lg transition-colors duration-150 inline-flex items-center">
