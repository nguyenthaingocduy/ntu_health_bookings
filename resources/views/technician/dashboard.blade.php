...
<div class="container mx-auto px-6 py-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-2">
            <a href="{{ route('technician.schedule') }}" class="flex items-center px-4 py-2 bg-indigo-500 text-white rounded-lg hover:bg-indigo-600 transition-colors duration-150 shadow-md">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
            ...
            <div class="p-6">
                ...
                <div class="mt-4">
                    <a href="{{ route('technician.schedule') }}" class="block w-full text-center px-4 py-2 bg-indigo-100 text-indigo-700 rounded-lg hover:bg-indigo-200 transition-colors duration-150">
                        Xem lịch làm việc
                    </a>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
            ...
            <div class="p-6">
                ...
                <div class="mt-4">
                    <a href="{{ route('technician.sessions.completed') }}" class="block w-full text-center px-4 py-2 bg-green-100 text-green-700 rounded-lg hover:bg-green-200 transition-colors duration-150">
                        Xem chi tiết
                    </a>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
            ...
            <div class="p-6">
                ...
                <div class="mt-4">
                    <a href="{{ route('technician.notes.index') }}" class="block w-full text-center px-4 py-2 bg-purple-100 text-purple-700 rounded-lg hover:bg-purple-200 transition-colors duration-150">
                        Xem ghi chú
                    </a>
                </div>
            </div>
                            ...
                            @if(isset($todayAppointments) && count($todayAppointments) > 0)
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $appointment->time_slot->start_time }} - {{ $appointment->time_slot->end_time }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('technician.sessions.show', $appointment->id) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">Chi tiết</a>
                                    </td>
                                </tr>
                                @endforeach
                            @else
