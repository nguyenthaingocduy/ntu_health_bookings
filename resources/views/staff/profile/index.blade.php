        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <span class="badge bg-primary rounded-pill">{{ $staff->staffAppointments->count() }}</span>
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <span class="badge bg-warning rounded-pill">{{ $staff->staffAppointments->where('status', 'pending')->count() }}</span>
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <span class="badge bg-info rounded-pill">{{ $staff->staffAppointments->where('status', 'confirmed')->count() }}</span>
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <span class="badge bg-success rounded-pill">{{ $staff->staffAppointments->where('status', 'completed')->count() }}</span>
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-danger rounded-pill">{{ $staff->staffAppointments->where('status', 'cancelled')->count() }}</span>
                </div>
            </div>
        </div>
